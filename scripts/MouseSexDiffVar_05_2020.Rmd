...
overall2 <- rbind(extract_trait(overall1, "Behaviour"), 
...
heterog4 <- rbind(heteroCVR.ci, heteroVR.ci, heteroRR.ci) %>% select(GroupingTerm, parameter, value, ci.low, ci.high)
...
plot3.male.meta.CVR.b <- rbind(plot3.male.meta.CVR.b, add.row.hearing)
...
lnRR.ci <- overall3.male.sig           %>%
           ...
           mutate(ci.low = lnRR_lower, 
                 ci.high = lnRR_upper)
overall4.male.sig <- rbind(lnCVR.ci, lnRR.ci) %>% 
                     select(GroupingTerm, 
                            parameter, 
                            value, 
                            ci.low, 
...
plot3.female.meta.CVR.b <- rbind(plot3.female.meta.CVR.b, add.row.hearing)
...
lnRR.ci <- overall3.female.sig %>%
  filter(parameter == "lnRR") %>%
  mutate(ci.low = lnRR_lower, ci.high = lnRR_upper)
overall4.female.sig <- rbind(lnCVR.ci, lnRR.ci) %>% 
...
overall4.female.sigS <- rbind(lnCVR.ci, lnVR.ci, lnRR.ci) %>% select(GroupingTerm, parameter, value, ci.low, ci.high)
...
overall4.perc <- rbind(lnCVR.ci, lnVR.ci, lnRR.ci) %>% select(GroupingTerm, parameter, value, ci.low, ci.high)
...
overall4.male.sigS <- rbind(lnCVR.ci, lnVR.ci, lnRR.ci) %>% 
                      select(GroupingTerm, parameter, value, ci.low, ci.high) %>%
...
overall4.male.perc <- rbind(lnCVR.ci,lnVR.ci, lnRR.ci) %>% select(GroupingTerm, parameter, value, ci.low, ci.high) 
