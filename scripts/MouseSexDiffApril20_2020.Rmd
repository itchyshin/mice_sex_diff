...
MISSING table descpition. Refer to in ms.
```{r Table4}
...
### Supplemental Table 5: "Heterogeneity within groups"
 SZ: missing a desciption so far. MISSING!! Also: rearrange table structure, what does this show??
```{r}
kable(heterog6, digits = 3) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "200px")
```
