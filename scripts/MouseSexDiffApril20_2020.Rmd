...
```{r FigG1, fig.width = 4, fig.height = 8, fig.cap="Workflow of data process and meta-analysis"}
...
## Figure
Figure \@ref(fig:FigS1) is similar to Figure 3 in the main article.
...
### Sex-bias in traits: Methods and results 
