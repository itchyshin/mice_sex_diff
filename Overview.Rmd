...
```{r}
select(filter(data, biological_sample_id == "107609"), sex, production_center, project_name, biological_sample_id, age_in_days, weight, parameter_name) %>% arrange(age_in_days) %>% data.frame()
```
